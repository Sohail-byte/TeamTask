...
signupRouter.post("/signup", async (req, res) => {
  ...
  try {
    ...
    if (existingUserName || existingUserEmail) {
      if (existingUserName && existingUserEmail) {
        return res.render("user-forms/signup.ejs", {
    ...
    res.status(201).render("user-forms/signup.ejs", {
      error:
        "Please verify your email. An email has been sent to your email account",
    })
